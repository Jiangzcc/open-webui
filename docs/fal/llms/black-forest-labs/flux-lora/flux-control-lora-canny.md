...
- **Model ID**: `fal-ai/flux-control-lora-canny`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-control-lora-canny \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-control-lora-canny)
- [API Documentation](https://fal.ai/models/fal-ai/flux-control-lora-canny/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-control-lora-canny)
