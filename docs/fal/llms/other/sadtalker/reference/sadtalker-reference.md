...
- **Endpoint**: `https://fal.run/fal-ai/sadtalker/reference`
- **Model ID**: `fal-ai/sadtalker/reference`
...
- **`reference_pose_video_url`** (`string`, _required_):
  URL of the reference video
  - Examples: "https://github.com/OpenTalker/SadTalker/raw/main/examples/ref_video/WDA_AlexandriaOcasioCortez_000.mp4"
...
```json
{
  ...
  "reference_pose_video_url": "https://github.com/OpenTalker/SadTalker/raw/main/examples/ref_video/WDA_AlexandriaOcasioCortez_000.mp4"
}
```
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/sadtalker/reference \
...
- [Model Playground](https://fal.ai/models/fal-ai/sadtalker/reference)
- [API Documentation](https://fal.ai/models/fal-ai/sadtalker/reference/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sadtalker/reference)
