...
- **Endpoint**: `https://fal.run/fal-ai/wan-vace-14b/outpainting`
- **Model ID**: `fal-ai/wan-vace-14b/outpainting`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan-vace-14b/outpainting \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan-vace-14b/outpainting)
- [API Documentation](https://fal.ai/models/fal-ai/wan-vace-14b/outpainting/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/outpainting)
