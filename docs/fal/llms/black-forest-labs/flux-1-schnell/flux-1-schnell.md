...
- **Endpoint**: `https://fal.run/fal-ai/flux-1/schnell`
- **Model ID**: `fal-ai/flux-1/schnell`
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-1/schnell)
- [API Documentation](https://fal.ai/models/fal-ai/flux-1/schnell/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-1/schnell)
