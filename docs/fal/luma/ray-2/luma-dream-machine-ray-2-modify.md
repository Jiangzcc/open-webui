...
- **Endpoint**: `https://fal.run/fal-ai/luma-dream-machine/ray-2/modify`
- **Model ID**: `fal-ai/luma-dream-machine/ray-2/modify`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/luma-dream-machine/ray-2/modify \
...
- [Model Playground](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2/modify)
- [API Documentation](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2/modify/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-dream-machine/ray-2/modify)
