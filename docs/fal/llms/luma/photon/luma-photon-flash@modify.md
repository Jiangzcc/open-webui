...
- **Endpoint**: `https://fal.run/fal-ai/luma-photon/flash/modify`
- **Model ID**: `fal-ai/luma-photon/flash/modify`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/luma-photon/flash/modify \
...
- [Model Playground](https://fal.ai/models/fal-ai/luma-photon/flash/modify)
- [API Documentation](https://fal.ai/models/fal-ai/luma-photon/flash/modify/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-photon/flash/modify)
