...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-22b/distilled/video-to-video/lora`
- **Model ID**: `fal-ai/ltx-2.3-22b/distilled/video-to-video/lora`
...
- **`video_strength`** (`float`, _optional_):
  Video conditioning strength. Lower values represent more freedom given to the model to change the video content. Default value: `0.01`
  - Default: `0.01`
  - Range: `0` to `1`

- **`audio_strength`** (`float`, _optional_):
  Audio conditioning strength. Lower values represent more freedom given to the model to change the audio content. Default value: `0.01`
  - Default: `0.01`
  - Range: `0` to `1`
...
- **`video`** (`VideoFile`, _required_):
  The generated video.
  - Examples: {"width":1248,"duration":6.44,"height":704,"fps":25,"content_type":"video/mp4","url":"https://v3b.fal.media/files/b/0a922b2c/GHF1uJnBb0iuYWQDuZrzG_WAtgthsP.mp4","file_name":"GHF1uJnBb0iuYWQDuZrzG_WAtgthsP.mp4","num_frames":161}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-22b/distilled/video-to-video/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-22b/distilled/video-to-video/lora", {
  input: {
    prompt: "style: cinematic/realistic. A man wearing a baseball cap walks through a modern town. He holds a coffee cup.",
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4",
    loras: [{
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/video-to-video/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-22b/distilled/video-to-video/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-22b/distilled/video-to-video/lora)
