...
- **Endpoint**: `https://fal.run/fal-ai/sam-3-1/video`
- **Model ID**: `fal-ai/sam-3-1/video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/sam-3-1/video \
...
- [Model Playground](https://fal.ai/models/fal-ai/sam-3-1/video)
- [API Documentation](https://fal.ai/models/fal-ai/sam-3-1/video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sam-3-1/video)
