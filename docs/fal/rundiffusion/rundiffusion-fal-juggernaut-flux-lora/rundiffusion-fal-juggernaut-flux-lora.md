...
- **Endpoint**: `https://fal.run/rundiffusion-fal/juggernaut-flux-lora`
- **Model ID**: `rundiffusion-fal/juggernaut-flux-lora`
...
```bash
curl --request POST \
  --url https://fal.run/rundiffusion-fal/juggernaut-flux-lora \
...
- [Model Playground](https://fal.ai/models/rundiffusion-fal/juggernaut-flux-lora)
- [API Documentation](https://fal.ai/models/rundiffusion-fal/juggernaut-flux-lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=rundiffusion-fal/juggernaut-flux-lora)
