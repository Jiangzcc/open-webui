...
- **Endpoint**: `https://fal.run/fal-ai/recraft/v4/text-to-vector`
- **Model ID**: `fal-ai/recraft/v4/text-to-vector`
...
- **`images`** (`list<File>`, _required_)
  - Array of File
  - Examples: [{"content_type":"image/svg+xml","file_name":"image.svg","file_size":1722022,"url":"https://v3b.fal.media/files/b/0a8ee4fd/sw8YD36iblpO64JeQZEDt_image.svg"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/recraft/v4/text-to-vector \
...
- [Model Playground](https://fal.ai/models/fal-ai/recraft/v4/text-to-vector)
- [API Documentation](https://fal.ai/models/fal-ai/recraft/v4/text-to-vector/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/recraft/v4/text-to-vector)
