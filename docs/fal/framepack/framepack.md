...
- **Endpoint**: `https://fal.run/fal-ai/framepack`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/framepack \
...
- [Model Playground](https://fal.ai/models/fal-ai/framepack)
- [API Documentation](https://fal.ai/models/fal-ai/framepack/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/framepack)
