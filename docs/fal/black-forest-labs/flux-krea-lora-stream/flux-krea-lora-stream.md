...
- **Endpoint**: `https://fal.run/fal-ai/flux-krea-lora/stream`
- **Model ID**: `fal-ai/flux-krea-lora/stream`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-krea-lora/stream \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-krea-lora/stream)
- [API Documentation](https://fal.ai/models/fal-ai/flux-krea-lora/stream/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-krea-lora/stream)
