...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/cross-eyed`
- **Model ID**: `fal-ai/ltx-2.3-quality/cross-eyed`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/cross-eyed \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/cross-eyed", {
  input: {
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/cross-eyed)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/cross-eyed/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/cross-eyed)
