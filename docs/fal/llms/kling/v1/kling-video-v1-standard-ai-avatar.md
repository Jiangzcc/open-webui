...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v1/standard/ai-avatar`
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v1/standard/ai-avatar)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v1/standard/ai-avatar/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1/standard/ai-avatar)
