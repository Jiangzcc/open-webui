...
- **Endpoint**: `https://fal.run/fal-ai/flux-1/krea`
- **Model ID**: `fal-ai/flux-1/krea`
...
- **`images`** (`list<Image>`, _required_):
  ...
  - Array of Image
  - Examples: [{"height":768,"width":1024,"content_type":"image/jpeg","url":"https://storage.googleapis.com/falserverless/example_outputs/flux_krea_t2i_output_1.jpg"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-1/krea \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-1/krea)
- [API Documentation](https://fal.ai/models/fal-ai/flux-1/krea/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-1/krea)
