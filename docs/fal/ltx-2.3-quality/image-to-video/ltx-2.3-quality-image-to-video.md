...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/image-to-video`
- **Model ID**: `fal-ai/ltx-2.3-quality/image-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/image-to-video \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/image-to-video", {
  input: {
    prompt: "A woman stands still amid a busy neon-lit street at night. The camera slowly dollies in toward her face as people blur past, their motion emphasizing her calm presence.",
    image_url: "https://storage.googleapis.com/falserverless/example_inputs/ltxv-2-i2v-input.jpg"
  },
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/image-to-video)
