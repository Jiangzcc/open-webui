...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/extend-video/lora`
- **Model ID**: `fal-ai/ltx-2.3-quality/extend-video/lora`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/extend-video/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/extend-video/lora", {
  input: {
    prompt: "Continue the scene naturally, maintaining the same style and motion.",
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4",
    loras: [{
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/extend-video/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/extend-video/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/extend-video/lora)
