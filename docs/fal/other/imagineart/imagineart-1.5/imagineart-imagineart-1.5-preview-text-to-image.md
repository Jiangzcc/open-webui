...
- **Endpoint**: `https://fal.run/imagineart/imagineart-1.5-preview/text-to-image`
- **Model ID**: `imagineart/imagineart-1.5-preview/text-to-image`
...
- **`images`** (`list<Image>`, _required_):
  Generated image
  - Array of Image
  - Examples: [{"content_type":"image/png","height":2048,"width":2048,"url":"https://v3b.fal.media/files/b/0a961724/CX6N_t6PCQujw0ZxIQMYF_generated_ImagineArt_1_5.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/imagineart/imagineart-1.5-preview/text-to-image \
...
- [Model Playground](https://fal.ai/models/imagineart/imagineart-1.5-preview/text-to-image)
- [API Documentation](https://fal.ai/models/imagineart/imagineart-1.5-preview/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=imagineart/imagineart-1.5-preview/text-to-image)
