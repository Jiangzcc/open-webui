...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-22b/reference-video-to-video`
- **Model ID**: `fal-ai/ltx-2.3-22b/reference-video-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-22b/reference-video-to-video \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-22b/reference-video-to-video", {
  input: {
    prompt: "style: cinematic/realistic. A man wearing a baseball cap walks through a modern town. He holds a coffee cup.",
    video_url: "https://v3b.fal.media/files/b/0a963ecf/eVoII1AsconU8SpPx5xoE_output.mp4"
  },
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-22b/reference-video-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-22b/reference-video-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-22b/reference-video-to-video)
