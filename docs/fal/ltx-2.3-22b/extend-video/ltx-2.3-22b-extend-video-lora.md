...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-22b/extend-video/lora`
- **Model ID**: `fal-ai/ltx-2.3-22b/extend-video/lora`
...
- **`video`** (`VideoFile`, _required_):
  The generated video.
  - Examples: {"width":1248,"duration":6.44,"height":704,"fps":25,"content_type":"video/mp4","url":"https://v3b.fal.media/files/b/0a894013/N9lnMTq7W3uMC0lOQg845_BknRPV8I.mp4","file_name":"CJcQGDrxOSRg2YFl5GNDt_glXPMoji.mp4","num_frames":161}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-22b/extend-video/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-22b/extend-video/lora", {
  input: {
    prompt: "Continue the scene naturally, maintaining the same style and motion.",
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4",
    loras: [{
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-22b/extend-video/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-22b/extend-video/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-22b/extend-video/lora)
