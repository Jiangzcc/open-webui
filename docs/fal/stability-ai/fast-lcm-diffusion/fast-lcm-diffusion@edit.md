...
- **Endpoint**: `https://fal.run/fal-ai/fast-lcm-diffusion/image-to-image`
- **Model ID**: `fal-ai/fast-lcm-diffusion/image-to-image`
- **Category**: image-to-image
- **Kind**: inference
**Tags**: lcm, diffusion, turbo, real-time, editing
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/fast-lcm-diffusion/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-lcm-diffusion/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/fast-lcm-diffusion/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-lcm-diffusion/image-to-image)
- [GitHub Repository](https://huggingface.co/latent-consistency/lcm-lora-sdxl/blob/main/README.md)
