...
- **Endpoint**: `https://fal.run/fal-ai/stable-diffusion-v3-medium`
- **Model ID**: `fal-ai/stable-diffusion-v3-medium`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Digital art, portrait of an anthropomorphic roaring Tiger warrior with full armor, close up in the middle of a battle, behind him there is a banner with the text \"Open Source\""
...
- [Model Playground](https://fal.ai/models/fal-ai/stable-diffusion-v3-medium)
- [API Documentation](https://fal.ai/models/fal-ai/stable-diffusion-v3-medium/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/stable-diffusion-v3-medium)
