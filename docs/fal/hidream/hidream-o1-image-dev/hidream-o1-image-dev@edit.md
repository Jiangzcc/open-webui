...
- **Endpoint**: `https://fal.run/fal-ai/hidream-o1-image/dev/edit`
- **Model ID**: `fal-ai/hidream-o1-image/dev/edit`
...
- **`num_inference_steps`** (`integer`, _optional_):
  Number of denoising steps. The dev model is distilled for 28 steps. Default value: `28`
  - Default: `28`
  - Range: `1` to `28`

- **`guidance_scale`** (`float`, _optional_):
  Classifier-free guidance scale. The dev model uses 0.0 by default.
  - Default: `0`
  - Range: `0` to `20`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/hidream-o1-image/dev/edit \
...
const result = await fal.subscribe("fal-ai/hidream-o1-image/dev/edit", {
  input: {
    prompt: "A cinematic product photo of a ceramic mug on a marble counter, soft window light, shallow depth of field.",
    reference_image_urls: ["https://storage.googleapis.com/falserverless/model_tests/hidream/woman.png"]
  },
...
- [Model Playground](https://fal.ai/models/fal-ai/hidream-o1-image/dev/edit)
- [API Documentation](https://fal.ai/models/fal-ai/hidream-o1-image/dev/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hidream-o1-image/dev/edit)
