...
- **Endpoint**: `https://fal.run/fal-ai/flux-1/dev/image-to-image`
- **Model ID**: `fal-ai/flux-1/dev/image-to-image`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-1/dev/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-1/dev/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/flux-1/dev/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-1/dev/image-to-image)
