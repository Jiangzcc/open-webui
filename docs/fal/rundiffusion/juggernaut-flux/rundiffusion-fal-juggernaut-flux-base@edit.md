...
- **Endpoint**: `https://fal.run/rundiffusion-fal/juggernaut-flux/base/image-to-image`
- **Model ID**: `rundiffusion-fal/juggernaut-flux/base/image-to-image`
...
```bash
curl --request POST \
  --url https://fal.run/rundiffusion-fal/juggernaut-flux/base/image-to-image \
...
- [Model Playground](https://fal.ai/models/rundiffusion-fal/juggernaut-flux/base/image-to-image)
- [API Documentation](https://fal.ai/models/rundiffusion-fal/juggernaut-flux/base/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=rundiffusion-fal/juggernaut-flux/base/image-to-image)
