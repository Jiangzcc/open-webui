...
- **Endpoint**: `https://fal.run/fal-ai/ltx-video-13b-distilled/extend`
- **Model ID**: `fal-ai/ltx-video-13b-distilled/extend`
- **Category**: video-to-video
- **Kind**: inference
**Tags**: video, ltx-video, video-to-video, extend-video
...
- **`video`** (`ExtendVideoConditioningInput`, _required_):
  ...
  - Examples: {"target_fps":24,"preprocess":false,"resample_fps":false,"conditioning_type":"rgb","reverse_video":false,"video_url":"https://storage.googleapis.com/falserverless/web-examples/wan/t2v.mp4","limit_num_frames":false,"max_num_frames":1441,"start_frame_num":0,"strength":1}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-video-13b-distilled/extend \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/extend)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/extend/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video-13b-distilled/extend)
