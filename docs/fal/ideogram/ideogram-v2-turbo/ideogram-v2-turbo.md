...
- **Endpoint**: `https://fal.run/fal-ai/ideogram/v2/turbo`
- **Model ID**: `fal-ai/ideogram/v2/turbo`
...
- [Model Playground](https://fal.ai/models/fal-ai/ideogram/v2/turbo)
- [API Documentation](https://fal.ai/models/fal-ai/ideogram/v2/turbo/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ideogram/v2/turbo)
