...
- **Endpoint**: `https://fal.run/fal-ai/sdxl-controlnet-union/image-to-image`
- **Model ID**: `fal-ai/sdxl-controlnet-union/image-to-image`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/sdxl-controlnet-union/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/sdxl-controlnet-union/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/sdxl-controlnet-union/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sdxl-controlnet-union/image-to-image)
