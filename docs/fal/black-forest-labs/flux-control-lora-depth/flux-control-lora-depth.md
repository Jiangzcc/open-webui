...
- **Model ID**: `fal-ai/flux-control-lora-depth`
...
- **`image_url`** (`string`, _optional_):
  URL of image to use for image-to-image generation.
...
- **`preprocess_depth`** (`boolean`, _optional_):
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-control-lora-depth \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-control-lora-depth)
- [API Documentation](https://fal.ai/models/fal-ai/flux-control-lora-depth/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-control-lora-depth)
