...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/reference-video-to-video`
- **Model ID**: `fal-ai/ltx-2.3-quality/reference-video-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/reference-video-to-video \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/reference-video-to-video", {
  input: {
    prompt: "A dancer in a flowing red dress against a black backdrop, studio lighting, cinematic.",
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4"
  },
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/reference-video-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/reference-video-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/reference-video-to-video)
