...
- **Endpoint**: `https://fal.run/fal-ai/hidream-o1-image/dev`
- **Model ID**: `fal-ai/hidream-o1-image/dev`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/hidream-o1-image/dev \
...
const result = await fal.subscribe("fal-ai/hidream-o1-image/dev", {
  input: {
    prompt: "A cinematic product photo of a ceramic mug on a marble counter, soft window light, shallow depth of field."
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/hidream-o1-image/dev)
- [API Documentation](https://fal.ai/models/fal-ai/hidream-o1-image/dev/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hidream-o1-image/dev)
