...
- **Endpoint**: `https://fal.run/blackforestlabs/flux-3/image-to-video/draft`
- **Model ID**: `blackforestlabs/flux-3/image-to-video/draft`
...
```bash
curl --request POST \
  --url https://fal.run/blackforestlabs/flux-3/image-to-video/draft \
...
const result = await fal.subscribe("blackforestlabs/flux-3/image-to-video/draft", {
  input: {
    prompt: "A red panda walks along a mossy log in a sunlit forest, one continuous unbroken shot.",
    image_url: "https://storage.googleapis.com/falserverless/example_inputs/veo31_i2v_input.jpg"
  },
...
- [Model Playground](https://fal.ai/models/blackforestlabs/flux-3/image-to-video/draft)
- [API Documentation](https://fal.ai/models/blackforestlabs/flux-3/image-to-video/draft/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=blackforestlabs/flux-3/image-to-video/draft)
