...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"file_size":5485412,"file_name":"output.mp4","content_type":"video/mp4","url":"https://storage.googleapis.com/falserverless/model_tests/video_models/output-4.mp4"}
