...
- **Endpoint**: `https://fal.run/fal-ai/cosmos-predict-2.5/video-to-video`
- **Model ID**: `fal-ai/cosmos-predict-2.5/video-to-video`
...
- **`video_url`** (`string`, _required_):
  ...
  - Examples: "https://v3b.fal.media/files/b/0a8fabc5/qAi19s0dSuQHDZ3O7D_HV_FkSwbls1.mp4"
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/cosmos-predict-2.5/video-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/cosmos-predict-2.5/video-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/cosmos-predict-2.5/video-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/cosmos-predict-2.5/video-to-video)
