...
- **Endpoint**: `https://fal.run/fal-ai/wan-vace-14b`
- **Model ID**: `fal-ai/wan-vace-14b`
...
- **`task`** (`TaskEnum`, _optional_):
  ...
  - Default: `"depth"`
  - Options: `"depth"`, `"pose"`, `"inpainting"`, `"outpainting"`, `"reframe"`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan-vace-14b \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan-vace-14b)
- [API Documentation](https://fal.ai/models/fal-ai/wan-vace-14b/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b)
