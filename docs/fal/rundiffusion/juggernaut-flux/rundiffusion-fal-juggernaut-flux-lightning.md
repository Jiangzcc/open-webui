...
- **Endpoint**: `https://fal.run/rundiffusion-fal/juggernaut-flux/lightning`
- **Model ID**: `rundiffusion-fal/juggernaut-flux/lightning`
...
```bash
curl --request POST \
  --url https://fal.run/rundiffusion-fal/juggernaut-flux/lightning \
...
- [Model Playground](https://fal.ai/models/rundiffusion-fal/juggernaut-flux/lightning)
- [API Documentation](https://fal.ai/models/rundiffusion-fal/juggernaut-flux/lightning/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=rundiffusion-fal/juggernaut-flux/lightning)
