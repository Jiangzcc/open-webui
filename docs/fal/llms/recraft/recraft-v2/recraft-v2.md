...
> Recraft V2 is a new and affordable text-to-image model.


## Overview

- **Endpoint**: `https://fal.run/fal-ai/recraft/v2/text-to-image`
- **Model ID**: `fal-ai/recraft/v2/text-to-image`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: vector art, typograph, style
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/recraft/v2/text-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/recraft/v2/text-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/recraft/v2/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/recraft/v2/text-to-image)
