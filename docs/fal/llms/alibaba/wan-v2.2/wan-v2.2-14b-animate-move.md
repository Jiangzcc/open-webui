...
- **Endpoint**: `https://fal.run/fal-ai/wan/v2.2-14b/animate/move`
- **Model ID**: `fal-ai/wan/v2.2-14b/animate/move`
...
- **`video`** (`File`, _required_):
  ...
  - Examples: {"url":"https://v3b.fal.media/files/b/monkey/xjJYzO0jqMi7MxufJe5tx_wan_animate_output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan/v2.2-14b/animate/move \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan/v2.2-14b/animate/move)
- [API Documentation](https://fal.ai/models/fal-ai/wan/v2.2-14b/animate/move/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-14b/animate/move)
