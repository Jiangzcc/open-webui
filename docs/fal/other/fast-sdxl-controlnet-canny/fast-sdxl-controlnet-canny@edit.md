...
- **Endpoint**: `https://fal.run/fal-ai/fast-sdxl-controlnet-canny/image-to-image`
- **Model ID**: `fal-ai/fast-sdxl-controlnet-canny/image-to-image`
- **Category**: image-to-image
- **Kind**: inference
**Tags**: diffusion, controlnet, editing, manipulation
...
- **`control_image_url`** (`string`, _required_):
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/fast-sdxl-controlnet-canny/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl-controlnet-canny/image-to-image)
