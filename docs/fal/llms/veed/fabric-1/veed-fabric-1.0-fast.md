...
480p - $0.10 per second, 720p - $0.20 per second
...
```bash
curl --request POST \
  --url https://fal.run/veed/fabric-1.0/fast \
...
- [Model Playground](https://fal.ai/models/veed/fabric-1.0/fast)
- [API Documentation](https://fal.ai/models/veed/fabric-1.0/fast/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=veed/fabric-1.0/fast)
