...
- **Endpoint**: `https://fal.run/fal-ai/fast-lcm-diffusion`
- **Model ID**: `fal-ai/fast-lcm-diffusion`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: lcm, diffusion, turbo, real-time
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Self-portrait oil painting, a beautiful cyborg with golden hair, 8k."
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/fast-lcm-diffusion \
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-lcm-diffusion)
- [API Documentation](https://fal.ai/models/fal-ai/fast-lcm-diffusion/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-lcm-diffusion)
