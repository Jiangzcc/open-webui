...
- **Endpoint**: `https://fal.run/fal-ai/luma-dream-machine/ray-2/reframe`
- **Model ID**: `fal-ai/luma-dream-machine/ray-2/reframe`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/luma-dream-machine/ray-2/reframe \
...
- [Model Playground](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2/reframe)
- [API Documentation](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2/reframe/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-dream-machine/ray-2/reframe)
