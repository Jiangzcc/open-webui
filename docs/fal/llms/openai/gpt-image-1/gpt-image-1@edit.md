...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"url":"https://storage.googleapis.com/falserverless/model_tests/gpt-image-1/cyberpunk_pixel.png","height":1536,"width":1024,"file_name":"cyberpunk_pixel.png","content_type":"image/png"}]
