...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('provider_status_url', sa.String(4096), nullable=True),
        sa.Column('provider_response_url', sa.String(4096), nullable=True),
        sa.Column('provider_result_url', sa.String(4096), nullable=True),
