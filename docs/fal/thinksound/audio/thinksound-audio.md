...
- **Endpoint**: `https://fal.run/fal-ai/thinksound/audio`
- **Model ID**: `fal-ai/thinksound/audio`
...
- **`audio`** (`File`, _required_):
  ...
  - Examples: {"url":"https://storage.googleapis.com/falserverless/example_outputs/thinksound-audio.wav"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/thinksound/audio \
...
- [Model Playground](https://fal.ai/models/fal-ai/thinksound/audio)
- [API Documentation](https://fal.ai/models/fal-ai/thinksound/audio/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/thinksound/audio)
