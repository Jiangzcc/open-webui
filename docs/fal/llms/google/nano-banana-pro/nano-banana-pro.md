...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"content_type":"image/png","file_name":"nano-banana-pro-t2i-output.png","url":"https://storage.googleapis.com/falserverless/example_outputs/nano-banana-pro-t2i-output.png"}]
