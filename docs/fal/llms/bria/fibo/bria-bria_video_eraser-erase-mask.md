...
- **Endpoint**: `https://fal.run/bria/bria_video_eraser/erase/mask`
- **Model ID**: `bria/bria_video_eraser/erase/mask`
...
```bash
curl --request POST \
  --url https://fal.run/bria/bria_video_eraser/erase/mask \
...
- [Model Playground](https://fal.ai/models/bria/bria_video_eraser/erase/mask)
- [API Documentation](https://fal.ai/models/bria/bria_video_eraser/erase/mask/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=bria/bria_video_eraser/erase/mask)
