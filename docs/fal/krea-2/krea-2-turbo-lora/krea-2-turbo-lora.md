...
- **Endpoint**: `https://fal.run/fal-ai/krea-2/turbo/lora`
- **Model ID**: `fal-ai/krea-2/turbo/lora`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: stylized, transform, typography, realism
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/krea-2/turbo/lora \
...
const result = await fal.subscribe("fal-ai/krea-2/turbo/lora", {
  input: {
    prompt: "a vintage travel poster for Mars"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/krea-2/turbo/lora)
- [API Documentation](https://fal.ai/models/fal-ai/krea-2/turbo/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/krea-2/turbo/lora)
