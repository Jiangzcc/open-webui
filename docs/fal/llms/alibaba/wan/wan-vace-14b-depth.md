...
- **Endpoint**: `https://fal.run/fal-ai/wan-vace-14b/depth`
- **Model ID**: `fal-ai/wan-vace-14b/depth`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan-vace-14b/depth \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan-vace-14b/depth)
- [API Documentation](https://fal.ai/models/fal-ai/wan-vace-14b/depth/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/depth)
