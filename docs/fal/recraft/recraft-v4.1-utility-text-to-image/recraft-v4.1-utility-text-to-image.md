...
- **Endpoint**: `https://fal.run/fal-ai/recraft/v4.1/utility/text-to-image`
- **Model ID**: `fal-ai/recraft/v4.1/utility/text-to-image`
...
- **`images`** (`list<File>`, _required_)
  - Array of File
  - Examples: [{"content_type":"image/webp","file_name":"image.webp","file_size":272628,"url":"https://storage.googleapis.com/falserverless/example_outputs/recraft-v4/standard-output.webp"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/recraft/v4.1/utility/text-to-image \
...
const result = await fal.subscribe("fal-ai/recraft/v4.1/utility/text-to-image", {
  input: {
    prompt: "Tilt-shift miniature effect on a real Portuguese fishing village at golden hour, colorful boats in the harbor appearing toy-like, selective focus band across the middle, saturated primary colors of blue red and yellow boats against white buildings, 90mm tilt-shift lens, the familiar made fantastical, Wes Anderson color sensibility"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/recraft/v4.1/utility/text-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/recraft/v4.1/utility/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/recraft/v4.1/utility/text-to-image)
