...
- **Endpoint**: `https://fal.run/krea/v2/medium/turbo/text-to-image`
- **Model ID**: `krea/v2/medium/turbo/text-to-image`
...
For every image you generate, you will be charged **$0.015** (text-to-image) or **$0.0175** (using image_style_references).
...
```bash
curl --request POST \
  --url https://fal.run/krea/v2/medium/turbo/text-to-image \
...
const result = await fal.subscribe("krea/v2/medium/turbo/text-to-image", {
  input: {
    prompt: "A Van Gogh-tinged Provençal farmhouse under starry nights."
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/krea/v2/medium/turbo/text-to-image)
- [API Documentation](https://fal.ai/models/krea/v2/medium/turbo/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=krea/v2/medium/turbo/text-to-image)
