...
- **Endpoint**: `https://fal.run/mirelo-ai/sfx-v1/video-to-video`
...
Your request will cost **$0.007** per second of output and per sample.
...
- **`video`** (`list<Video>`, _required_):
  ...
  - Array of Video
  - Examples: [{"file_name":"generated_output_1.mp4","content_type":"video/mp4","url":"https://di3otfzjg1gxa.cloudfront.net/generated_output_1.mp4"},{"file_name":"generated_output_2.mp4","content_type":"video/mp4","url":"https://di3otfzjg1gxa.cloudfront.net/generated_output_2.mp4"}]
...
```bash
curl --request POST \
  --url https://fal.run/mirelo-ai/sfx-v1/video-to-video \
...
- [Model Playground](https://fal.ai/models/mirelo-ai/sfx-v1/video-to-video)
- [API Documentation](https://fal.ai/models/mirelo-ai/sfx-v1/video-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=mirelo-ai/sfx-v1/video-to-video)
