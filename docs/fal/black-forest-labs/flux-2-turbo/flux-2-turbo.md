...
- **Endpoint**: `https://fal.run/fal-ai/flux-2/turbo`
- **Model ID**: `fal-ai/flux-2/turbo`
...
```json
{
  "prompt": "A realistic photograph of a vintage typewriter with a sheet of paper inserted that says 'Chapter One: The Journey Begins,' sunlight falling across the desk."
}
```
...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"url":"https://storage.googleapis.com/falserverless/example_outputs/flux-2-turbo-t2i.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-2/turbo \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-2/turbo)
- [API Documentation](https://fal.ai/models/fal-ai/flux-2/turbo/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/turbo)
