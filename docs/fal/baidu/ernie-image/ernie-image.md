...
- **Endpoint**: `https://fal.run/fal-ai/ernie-image`
- **Model ID**: `fal-ai/ernie-image`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: realism, chinese, multilingual, portrait, photorealistic
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ernie-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/ernie-image)
- [API Documentation](https://fal.ai/models/fal-ai/ernie-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ernie-image)
