...
- **Model ID**: `fal-ai/wan/v2.7/pro/text-to-image`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: wan, text-to-image, pro
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan/v2.7/pro/text-to-image \
...
const result = await fal.subscribe("fal-ai/wan/v2.7/pro/text-to-image", {
  input: {
    prompt: "An astronaut riding a horse in a photorealistic style."
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/wan/v2.7/pro/text-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/wan/v2.7/pro/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.7/pro/text-to-image)
