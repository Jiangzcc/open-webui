...
- **Endpoint**: `https://fal.run/fal-ai/z-image/turbo/lora`
- **Model ID**: `fal-ai/z-image/turbo/lora`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: z-image, lora, fast



## Pricing

- **Price**: $0.0085 per megapixels
...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"url":"https://storage.googleapis.com/falserverless/example_outputs/z-image-turbo-output.png","height":768,"content_type":"image/png","width":1024}]
...
- [Model Playground](https://fal.ai/models/fal-ai/z-image/turbo/lora)
- [API Documentation](https://fal.ai/models/fal-ai/z-image/turbo/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/z-image/turbo/lora)
