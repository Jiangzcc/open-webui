...
- **Endpoint**: `https://fal.run/fal-ai/one-to-all-animation/1.3b`
- **Model ID**: `fal-ai/one-to-all-animation/1.3b`
...
Your request will cost **$0.06** per **video second** for **720p**, **$0.045** per **video second** for **580p**, **$0.03** per **video second** for **480p**. 
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/one-to-all-animation/1.3b \
...
- [Model Playground](https://fal.ai/models/fal-ai/one-to-all-animation/1.3b)
- [API Documentation](https://fal.ai/models/fal-ai/one-to-all-animation/1.3b/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/one-to-all-animation/1.3b)
