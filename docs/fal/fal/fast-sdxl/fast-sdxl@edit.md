...
- **Model ID**: `fal-ai/fast-sdxl/image-to-image`
- **Category**: image-to-image
- **Kind**: inference
**Tags**: diffusion, high-res, lora, ip-adapter, controlnet
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-sdxl/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/fast-sdxl/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl/image-to-image)
