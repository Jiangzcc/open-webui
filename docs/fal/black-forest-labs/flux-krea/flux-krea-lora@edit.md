...
- **Endpoint**: `https://fal.run/fal-ai/flux-krea-lora/image-to-image`
- **Model ID**: `fal-ai/flux-krea-lora/image-to-image`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-krea-lora/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-krea-lora/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/flux-krea-lora/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-krea-lora/image-to-image)
