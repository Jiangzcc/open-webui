...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2-19b/extend-video/lora`
- **Model ID**: `fal-ai/ltx-2-19b/extend-video/lora`
...
Your request will cost $0.002 per megapixel of context frames plus generated video data (width × height × frames), rounded up. For example, if you generate a video that is 121 frames long at 1280 × 720, your total generated video is ≈112 MP, and your request will cost $0.224.
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2-19b/extend-video/lora \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2-19b/extend-video/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2-19b/extend-video/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/extend-video/lora)
