...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/water-simulation`
- **Model ID**: `fal-ai/ltx-2.3-quality/water-simulation`
- **Category**: video-to-video
- **Kind**: inference
**Tags**: water, simulation
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/water-simulation \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/water-simulation", {
  input: {
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/water-simulation)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/water-simulation/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/water-simulation)
