...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-general \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-general)
- [API Documentation](https://fal.ai/models/fal-ai/flux-general/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-general)
