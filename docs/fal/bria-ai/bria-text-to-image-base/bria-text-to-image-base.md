...
- **Endpoint**: `https://fal.run/fal-ai/bria/text-to-image/base`
- **Model ID**: `fal-ai/bria/text-to-image/base`
...
- [Model Playground](https://fal.ai/models/fal-ai/bria/text-to-image/base)
- [API Documentation](https://fal.ai/models/fal-ai/bria/text-to-image/base/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bria/text-to-image/base)
