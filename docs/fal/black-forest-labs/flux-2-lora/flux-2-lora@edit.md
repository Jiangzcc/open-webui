...
- **Endpoint**: `https://fal.run/fal-ai/flux-2/lora/edit`
- **Model ID**: `fal-ai/flux-2/lora/edit`
...
Requests cost **$0.021** per megapixel of input and output. Input images will be resized to 1MP. For example, a 1024x1024 generation with 512*512 size image input will cost **0.042** (1 MP input + 1 MP output, each costing **0.021**). LoRAs over 2GB in size will accrue an extra 50% charge per GB (2-3GB total lora size will multiply the price by 1.5x, 3-4GB total lora size by 2x, 4-5GB total lora size by 2.5x. The max limit is now 5GB from the older 2GB.
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Make this donut realistic"
...
- **`image_urls`** (`list<string>`, _required_):
  ...
  - Array of string
  - Examples: ["https://storage.googleapis.com/falserverless/example_inputs/flux2_dev_lora_edit_input.png"]
...
- **`images`** (`list<ImageFile>`, _required_):
  The edited images
  - Array of ImageFile
  - Examples: [{"url":"https://storage.googleapis.com/falserverless/example_outputs/flux2_dev_lora_edit_output.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-2/lora/edit \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-2/lora/edit)
- [API Documentation](https://fal.ai/models/fal-ai/flux-2/lora/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/lora/edit)
