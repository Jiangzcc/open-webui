...
- **Endpoint**: `https://fal.run/rundiffusion-fal/rundiffusion-photo-flux`
- **Model ID**: `rundiffusion-fal/rundiffusion-photo-flux`
...
- **`photo_lora_scale`** (`float`, _optional_):
...
```bash
curl --request POST \
  --url https://fal.run/rundiffusion-fal/rundiffusion-photo-flux \
...
- [Model Playground](https://fal.ai/models/rundiffusion-fal/rundiffusion-photo-flux)
- [API Documentation](https://fal.ai/models/rundiffusion-fal/rundiffusion-photo-flux/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=rundiffusion-fal/rundiffusion-photo-flux)
