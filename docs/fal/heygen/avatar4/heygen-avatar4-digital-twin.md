...
- **Endpoint**: `https://fal.run/fal-ai/heygen/avatar4/digital-twin`
- **Model ID**: `fal-ai/heygen/avatar4/digital-twin`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/heygen/avatar4/digital-twin \
...
- [Model Playground](https://fal.ai/models/fal-ai/heygen/avatar4/digital-twin)
- [API Documentation](https://fal.ai/models/fal-ai/heygen/avatar4/digital-twin/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/heygen/avatar4/digital-twin)
