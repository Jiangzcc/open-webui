...
- **Endpoint**: `https://fal.run/fal-ai/fooocus`
- **Model ID**: `fal-ai/fooocus`
...
- **`prompt`** (`string`, _optional_):
  ...
  - Default: `""`
  - Examples: "an astronaut in the jungle, cold color palette with butterflies in the background, highly detailed, 8k"
...
- **`control_image_url`** (`string`, _optional_):
  The image to use as a reference for the generated image.

- **`control_type`** (`ControlTypeEnum`, _optional_):
  The type of image control Default value: `"PyraCanny"`
  - Default: `"PyraCanny"`
  - Options: `"ImagePrompt"`, `"PyraCanny"`, `"CPDS"`, `"FaceSwap"`
  - Examples: "ImagePrompt", "PyraCanny", "CPDS", "FaceSwap"

- **`control_image_weight`** (`float`, _optional_):
...
- **`control_image_stop_at`** (`float`, _optional_):
...
- [Model Playground](https://fal.ai/models/fal-ai/fooocus)
- [API Documentation](https://fal.ai/models/fal-ai/fooocus/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fooocus)
