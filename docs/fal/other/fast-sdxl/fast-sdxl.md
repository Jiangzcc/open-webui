...
- **Kind**: inference
**Tags**: diffusion, lora, embeddings, high-res, style
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-sdxl)
- [API Documentation](https://fal.ai/models/fal-ai/fast-sdxl/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl)
