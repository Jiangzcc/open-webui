...
class ProviderInvocation(ProviderOpsBase):
    ...
    provider_status_url = Column(String(4096), nullable=True)
    provider_response_url = Column(String(4096), nullable=True)
    provider_result_url = Column(String(4096), nullable=True)
