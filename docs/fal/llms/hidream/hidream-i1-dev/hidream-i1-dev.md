...
- **Endpoint**: `https://fal.run/fal-ai/hidream-i1-dev`
- **Model ID**: `fal-ai/hidream-i1-dev`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/hidream-i1-dev \
...
- [Model Playground](https://fal.ai/models/fal-ai/hidream-i1-dev)
- [API Documentation](https://fal.ai/models/fal-ai/hidream-i1-dev/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hidream-i1-dev)
