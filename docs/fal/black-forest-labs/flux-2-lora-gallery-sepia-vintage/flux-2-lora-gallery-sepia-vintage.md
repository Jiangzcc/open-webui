...
- **Endpoint**: `https://fal.run/fal-ai/flux-2-lora-gallery/sepia-vintage`
- **Model ID**: `fal-ai/flux-2-lora-gallery/sepia-vintage`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "A portrait of a Victorian lady in sepia tones", "Vintage street scene with old cars, sepia photography", "Old family photo in sepia vintage style"
...
```json
{
  "prompt": "A portrait of a Victorian lady in sepia tones"
}
```
...
- **`images`** (`list<Image>`, _required_):
  ...
  - Array of Image
  - Examples: [{"url":"https://v3b.fal.media/files/b/zebra/qOMZKBNStQgVkaKB9SLY4.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-2-lora-gallery/sepia-vintage \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-2-lora-gallery/sepia-vintage)
- [API Documentation](https://fal.ai/models/fal-ai/flux-2-lora-gallery/sepia-vintage/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2-lora-gallery/sepia-vintage)
