...
- **Model ID**: `fal-ai/wan/v2.7/edit`
- **Category**: image-to-image
- **Kind**: inference
**Tags**: wan, image-to-image, image-editing
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan/v2.7/edit \
...
const result = await fal.subscribe("fal-ai/wan/v2.7/edit", {
  input: {
    prompt: "Turn image 1 into a watercolor painting.",
    image_urls: ["https://storage.googleapis.com/falserverless/model_tests/wan/dragon-warrior.jpg"]
  },
...
- [Model Playground](https://fal.ai/models/fal-ai/wan/v2.7/edit)
- [API Documentation](https://fal.ai/models/fal-ai/wan/v2.7/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.7/edit)
