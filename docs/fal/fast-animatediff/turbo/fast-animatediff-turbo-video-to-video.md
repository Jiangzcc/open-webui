...
- **Endpoint**: `https://fal.run/fal-ai/fast-animatediff/turbo/video-to-video`
- **Model ID**: `fal-ai/fast-animatediff/turbo/video-to-video`
...
- **`num_inference_steps`** (`integer`, _optional_):
  The number of inference steps to perform. 4-12 is recommended for turbo mode. Default value: `12`
  - Default: `12`
  - Range: `1` to `50`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/fast-animatediff/turbo/video-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-animatediff/turbo/video-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/fast-animatediff/turbo/video-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-animatediff/turbo/video-to-video)
