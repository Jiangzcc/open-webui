...
- **Endpoint**: `https://fal.run/fal-ai/wan-22-vace-fun-a14b/reframe`
- **Model ID**: `fal-ai/wan-22-vace-fun-a14b/reframe`
...
- **`video`** (`VideoFile`, _required_):
  ...
  - Examples: {"url":"https://storage.googleapis.com/falserverless/example_outputs/wan-vace-reframe-output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan-22-vace-fun-a14b/reframe \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan-22-vace-fun-a14b/reframe)
- [API Documentation](https://fal.ai/models/fal-ai/wan-22-vace-fun-a14b/reframe/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-22-vace-fun-a14b/reframe)
