...
- **Model ID**: `fal-ai/veo3.1/fast/extend-video`
...
- [Model Playground](https://fal.ai/models/fal-ai/veo3.1/fast/extend-video)
- [API Documentation](https://fal.ai/models/fal-ai/veo3.1/fast/extend-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1/fast/extend-video)
