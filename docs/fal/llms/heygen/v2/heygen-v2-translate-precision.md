...
- **Endpoint**: `https://fal.run/fal-ai/heygen/v2/translate/precision`
- **Model ID**: `fal-ai/heygen/v2/translate/precision`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/heygen/v2/translate/precision \
...
- [Model Playground](https://fal.ai/models/fal-ai/heygen/v2/translate/precision)
- [API Documentation](https://fal.ai/models/fal-ai/heygen/v2/translate/precision/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/heygen/v2/translate/precision)
