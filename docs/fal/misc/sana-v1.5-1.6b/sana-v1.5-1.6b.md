...
- **Endpoint**: `https://fal.run/fal-ai/sana/v1.5/1.6b`
- **Model ID**: `fal-ai/sana/v1.5/1.6b`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: text to image, 4k, lightweight



## Pricing

- **Price**: $0.0075 per megapixels
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/sana/v1.5/1.6b \
...
- [Model Playground](https://fal.ai/models/fal-ai/sana/v1.5/1.6b)
- [API Documentation](https://fal.ai/models/fal-ai/sana/v1.5/1.6b/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sana/v1.5/1.6b)
