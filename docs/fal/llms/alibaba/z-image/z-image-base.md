...
- **Endpoint**: `https://fal.run/fal-ai/z-image/base`
- **Model ID**: `fal-ai/z-image/base`
...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"content_type":"image/png","width":1024,"height":768,"url":"https://v3b.fal.media/files/b/0a8c18a5/1z0k9F1YLgz4qCr64jCBa_r2uqRyDg.png"}]
...
- [Model Playground](https://fal.ai/models/fal-ai/z-image/base)
- [API Documentation](https://fal.ai/models/fal-ai/z-image/base/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/z-image/base)
