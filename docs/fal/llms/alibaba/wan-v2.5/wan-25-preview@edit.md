...
- **`images`** (`list<ImageFile>`, _required_):
  The edited images
  - Array of ImageFile
  - Examples: [{"url":"https://v3.fal.media/files/rabbit/BM4J8xpV5ogtOQE9xGtft.png","content_type":"image/png"}]
...
result = fal_client.subscribe(
    "fal-ai/wan-v2.5/image-to-image",
    arguments={
        "prompt": "Reimagine the scene under a raging thunderstorm at night: lightning forks across the sky, illuminating the samurai in stark flashes of white light.",
...
const result = await fal.subscribe("fal-ai/wan-v2.5/image-to-image", {
  input: {
    prompt: "Reimagine the scene under a raging thunderstorm at night: lightning forks across the sky, illuminating the samurai in stark flashes of white light.",
    image_urls: ["https://v3.fal.media/files/penguin/4VZ7I1ZK5XNv33LV2JBxg.png"]
  },
