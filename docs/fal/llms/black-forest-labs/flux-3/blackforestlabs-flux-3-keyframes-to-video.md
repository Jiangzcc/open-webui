...
- **Endpoint**: `https://fal.run/blackforestlabs/flux-3/keyframes-to-video`
- **Model ID**: `blackforestlabs/flux-3/keyframes-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/blackforestlabs/flux-3/keyframes-to-video \
...
- [Model Playground](https://fal.ai/models/blackforestlabs/flux-3/keyframes-to-video)
- [API Documentation](https://fal.ai/models/blackforestlabs/flux-3/keyframes-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=blackforestlabs/flux-3/keyframes-to-video)
