...
- **Endpoint**: `https://fal.run/fal-ai/sana/sprint`
- **Model ID**: `fal-ai/sana/sprint`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: text to image, 4k, high-speed



## Pricing

- **Price**: $0.0025 per megapixels
...
- [Model Playground](https://fal.ai/models/fal-ai/sana/sprint)
- [API Documentation](https://fal.ai/models/fal-ai/sana/sprint/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sana/sprint)
