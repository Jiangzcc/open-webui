...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"file_name":"cyberpunk.png","width":1024,"url":"https://storage.googleapis.com/falserverless/model_tests/gpt-image-1/cyberpunk.png","height":1536,"content_type":"image/png"}]
