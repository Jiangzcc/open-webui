...
- **Endpoint**: `https://fal.run/fal-ai/flux-pro/v1.1-ultra-finetuned`
- **Model ID**: `fal-ai/flux-pro/v1.1-ultra-finetuned`
...
- **`finetune_id`** (`string`, _required_):
  References your specific model

- **`finetune_strength`** (`float`, _required_):
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-pro/v1.1-ultra-finetuned)
- [API Documentation](https://fal.ai/models/fal-ai/flux-pro/v1.1-ultra-finetuned/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/v1.1-ultra-finetuned)
