...
- **Endpoint**: `https://fal.run/fal-ai/luma-photon/flash`
- **Model ID**: `fal-ai/luma-photon/flash`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/luma-photon/flash \
...
- [Model Playground](https://fal.ai/models/fal-ai/luma-photon/flash)
- [API Documentation](https://fal.ai/models/fal-ai/luma-photon/flash/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-photon/flash)
