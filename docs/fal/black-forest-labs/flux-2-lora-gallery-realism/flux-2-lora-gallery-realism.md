...
- **Endpoint**: `https://fal.run/fal-ai/flux-2-lora-gallery/realism`
- **Model ID**: `fal-ai/flux-2-lora-gallery/realism`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "A portrait of a woman with natural lighting", "Street photography of a busy city scene", "Landscape photography of mountains at golden hour", "Documentary style photo of everyday life"
...
```json
{
  "prompt": "A portrait of a woman with natural lighting"
}
```
...
- **`images`** (`list<Image>`, _required_):
  ...
  - Array of Image
  - Examples: [{"url":"https://v3b.fal.media/files/b/koala/zjTCkqpflaiokwqCX3fKk.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/flux-2-lora-gallery/realism \
...
- [Model Playground](https://fal.ai/models/fal-ai/flux-2-lora-gallery/realism)
- [API Documentation](https://fal.ai/models/fal-ai/flux-2-lora-gallery/realism/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2-lora-gallery/realism)
