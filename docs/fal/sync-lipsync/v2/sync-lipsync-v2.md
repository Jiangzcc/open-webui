...
- **Endpoint**: `https://fal.run/fal-ai/sync-lipsync/v2`
...
- **`model`** (`ModelEnum`, _optional_):
  ...
  - Default: `"lipsync-2"`
  - Options: `"lipsync-2"`, `"lipsync-2-pro"`
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"url":"https://v3.fal.media/files/kangaroo/WIhlgDEJbccwGwAsvL3vz_output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/sync-lipsync/v2 \
...
- [Model Playground](https://fal.ai/models/fal-ai/sync-lipsync/v2)
- [API Documentation](https://fal.ai/models/fal-ai/sync-lipsync/v2/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sync-lipsync/v2)
