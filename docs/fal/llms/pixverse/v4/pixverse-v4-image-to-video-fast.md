...
- **Endpoint**: `https://fal.run/fal-ai/pixverse/v4/image-to-video/fast`
- **Model ID**: `fal-ai/pixverse/v4/image-to-video/fast`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/pixverse/v4/image-to-video/fast \
...
- [Model Playground](https://fal.ai/models/fal-ai/pixverse/v4/image-to-video/fast)
- [API Documentation](https://fal.ai/models/fal-ai/pixverse/v4/image-to-video/fast/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v4/image-to-video/fast)
