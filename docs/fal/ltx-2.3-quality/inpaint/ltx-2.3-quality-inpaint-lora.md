...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/inpaint/lora`
- **Model ID**: `fal-ai/ltx-2.3-quality/inpaint/lora`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/inpaint/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/inpaint/lora", {
  input: {
    prompt: "Replace the masked region with matching cinematic background detail.",
    video_url: "",
    mask_video_url: "",
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/inpaint/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/inpaint/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/inpaint/lora)
