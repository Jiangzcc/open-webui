...
- **Endpoint**: `https://fal.run/fal-ai/wan-vace-14b/reframe`
- **Model ID**: `fal-ai/wan-vace-14b/reframe`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan-vace-14b/reframe \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan-vace-14b/reframe)
- [API Documentation](https://fal.ai/models/fal-ai/wan-vace-14b/reframe/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/reframe)
