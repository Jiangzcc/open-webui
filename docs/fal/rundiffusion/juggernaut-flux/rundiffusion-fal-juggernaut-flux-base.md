...
- **Endpoint**: `https://fal.run/rundiffusion-fal/juggernaut-flux/base`
- **Model ID**: `rundiffusion-fal/juggernaut-flux/base`
...
```bash
curl --request POST \
  --url https://fal.run/rundiffusion-fal/juggernaut-flux/base \
...
- [Model Playground](https://fal.ai/models/rundiffusion-fal/juggernaut-flux/base)
- [API Documentation](https://fal.ai/models/rundiffusion-fal/juggernaut-flux/base/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=rundiffusion-fal/juggernaut-flux/base)
