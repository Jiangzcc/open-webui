...
- **Model ID**: `fal-ai/fast-sdxl-controlnet-canny`
- **Category**: text-to-image
- **Kind**: inference
**Tags**: diffusion, controlnet, manipulation
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/fast-sdxl-controlnet-canny \
...
- [Model Playground](https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny)
- [API Documentation](https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl-controlnet-canny)
