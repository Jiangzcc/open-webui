...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/hdr/lora`
- **Model ID**: `fal-ai/ltx-2.3-quality/hdr/lora`
- **Category**: video-to-video
- **Kind**: inference
**Tags**: video-to-video, lora
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/hdr/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/hdr/lora", {
  input: {
    prompt: "A sunset over the Pacific Ocean, vibrant orange and purple sky, deep contrast, cinematic HDR.",
    video_url: "",
    loras: [{
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/hdr/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/hdr/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/hdr/lora)
