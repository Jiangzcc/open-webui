...
- **Endpoint**: `https://fal.run/fal-ai/qwen-image-2/edit`
- **Model ID**: `fal-ai/qwen-image-2/edit`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Replace the cute kid with a chinese warrior."
...
- **`image_urls`** (`list<string>`, _required_):
  ...
  - Array of string
  - Examples: ["https://v3b.fal.media/files/b/0a90b2a1/i89tMXz0SmiwL0ZvbnUvS_image_00240.png"]
...
- **`images`** (`list<File>`, _required_):
  Generated images
  - Array of File
  - Examples: [{"url":"https://v3b.fal.media/files/b/0a90b2a1/VJ2suw3jKT7_VZ_6uz1Jb_TAY2WhAB.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/qwen-image-2/edit \
...
- [Model Playground](https://fal.ai/models/fal-ai/qwen-image-2/edit)
- [API Documentation](https://fal.ai/models/fal-ai/qwen-image-2/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-2/edit)
