...
- **Endpoint**: `https://fal.run/fal-ai/sana`
- **Model ID**: `fal-ai/sana`
...
- [Model Playground](https://fal.ai/models/fal-ai/sana)
- [API Documentation](https://fal.ai/models/fal-ai/sana/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sana)
- [GitHub Repository](https://github.com/NVlabs/Sana/blob/main/LICENSE)
