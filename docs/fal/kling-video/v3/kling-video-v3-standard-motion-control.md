...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v3/standard/motion-control`
- **Model ID**: `fal-ai/kling-video/v3/standard/motion-control`
...
- **`image_url`** (`string`, _required_):
  ...
  - Examples: "https://v3b.fal.media/files/b/0a90ee31/VHtWK5BZMa-XoT6gahJKS_077.png"
...
- **`video_url`** (`string`, _required_):
  ...
  - Examples: "https://v3b.fal.media/files/b/0a90edae/3nvl30ic9g2otKRcOV5nO_output.mp4"
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"url":"https://v3b.fal.media/files/b/0a90ee68/7-xpX-LTxX_nRHL776FrZ_output.mp4"}
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v3/standard/motion-control)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v3/standard/motion-control/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v3/standard/motion-control)
