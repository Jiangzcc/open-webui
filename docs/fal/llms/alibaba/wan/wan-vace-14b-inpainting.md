...
- **Endpoint**: `https://fal.run/fal-ai/wan-vace-14b/inpainting`
- **Model ID**: `fal-ai/wan-vace-14b/inpainting`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan-vace-14b/inpainting \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan-vace-14b/inpainting)
- [API Documentation](https://fal.ai/models/fal-ai/wan-vace-14b/inpainting/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/inpainting)
