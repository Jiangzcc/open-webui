...
- **Endpoint**: `https://fal.run/fal-ai/qwen-image/image-to-image`
- **Model ID**: `fal-ai/qwen-image/image-to-image`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Mount Fuji with purple japanese wisteria in the foreground, clear sky, peaceful spring day, soft natural light, landscape, painted with oil brush on a wood panel with abstract mixed colors"
...
- **`image_url`** (`string`, _required_):
  ...
  - Examples: "https://v3.fal.media/files/rabbit/KoIbq6nhDBDPxDQrivW-m.png"
...
```json
{
  "prompt": "Mount Fuji with purple japanese wisteria in the foreground, clear sky, peaceful spring day, soft natural light, landscape, painted with oil brush on a wood panel with abstract mixed colors",
...
- **`images`** (`list<Image>`, _required_):
  ...
  - Array of Image
  - Examples: [{"height":768,"content_type":"image/jpeg","width":1024,"url":"https://v3.fal.media/files/elephant/AuLvZGaYemu6vs36D5zof.png"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/qwen-image/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/qwen-image/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/qwen-image/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image/image-to-image)
