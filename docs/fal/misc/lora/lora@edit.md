...
- **Endpoint**: `https://fal.run/fal-ai/lora/image-to-image`
- **Model ID**: `fal-ai/lora/image-to-image`
- **Category**: image-to-image
- **Kind**: inference
**Tags**: diffusion, lora, customization, fine-tuning
...
- **`noise_strength`** (`float`, _optional_):
  The amount of noise to add to noise image for image. Only used if the image_url is provided. 1.0 is complete noise and values near 0 are minimal noise. Default value: `0.5`
  - Default: `0.5`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/lora/image-to-image \
...
- [Model Playground](https://fal.ai/models/fal-ai/lora/image-to-image)
- [API Documentation](https://fal.ai/models/fal-ai/lora/image-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/lora/image-to-image)
