...
- **Endpoint**: `https://fal.run/fal-ai/pixverse/v5/image-to-video`
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"file_size":6420765,"file_name":"output.mp4","content_type":"video/mp4","url":"https://storage.googleapis.com/falserverless/model_tests/video_models/output-3.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/pixverse/v5/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/pixverse/v5/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/pixverse/v5/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v5/image-to-video)
