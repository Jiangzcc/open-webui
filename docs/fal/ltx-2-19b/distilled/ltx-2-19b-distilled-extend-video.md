...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2-19b/distilled/extend-video`
- **Model ID**: `fal-ai/ltx-2-19b/distilled/extend-video`
...
Your request will cost $0.0008 per megapixel of context frames plus generated video data (width × height × frames), rounded up. For example, if you generate a video that is 121 frames long at 1280 × 720, your total generated video is ≈112 MP, and your request will cost $0.0896.
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2-19b/distilled/extend-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/extend-video)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2-19b/distilled/extend-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/distilled/extend-video)
