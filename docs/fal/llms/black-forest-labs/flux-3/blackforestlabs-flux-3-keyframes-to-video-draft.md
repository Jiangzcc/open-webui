...
- **Endpoint**: `https://fal.run/blackforestlabs/flux-3/keyframes-to-video/draft`
- **Model ID**: `blackforestlabs/flux-3/keyframes-to-video/draft`
...
- **`keyframes`** (`list<Flux3Keyframe>`, _required_):
  Keyframe images pinned to frame positions in the generated draft. Up to 10 keyframes with unique `frame_index` values.
  - Array of Flux3Keyframe
  - Examples: [{"frame_index":0,"image_url":"https://storage.googleapis.com/falserverless/example_inputs/veo31-flf2v-input-1.jpeg"},{"frame_index":120,"image_url":"https://storage.googleapis.com/falserverless/example_inputs/veo31-flf2v-input-2.jpeg"}]
...
```json
{
  ...
  "keyframes": [
    ...
    {
      "frame_index": 120,
      "image_url": "https://storage.googleapis.com/falserverless/example_inputs/veo31-flf2v-input-2.jpeg"
    }
  ]
}
```
...
```bash
curl --request POST \
  --url https://fal.run/blackforestlabs/flux-3/keyframes-to-video/draft \
...
const result = await fal.subscribe("blackforestlabs/flux-3/keyframes-to-video/draft", {
  input: {
    prompt: "A red panda walks along a mossy log in a sunlit forest, one continuous unbroken shot.",
    keyframes: [{
      frame_index: 0,
...
- [Model Playground](https://fal.ai/models/blackforestlabs/flux-3/keyframes-to-video/draft)
- [API Documentation](https://fal.ai/models/blackforestlabs/flux-3/keyframes-to-video/draft/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=blackforestlabs/flux-3/keyframes-to-video/draft)
