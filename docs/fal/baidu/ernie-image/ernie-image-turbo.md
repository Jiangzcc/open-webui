...
- **Endpoint**: `https://fal.run/fal-ai/ernie-image/turbo`
- **Model ID**: `fal-ai/ernie-image/turbo`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ernie-image/turbo \
...
- [Model Playground](https://fal.ai/models/fal-ai/ernie-image/turbo)
- [API Documentation](https://fal.ai/models/fal-ai/ernie-image/turbo/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ernie-image/turbo)
