...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/text-to-video/lora`
- **Model ID**: `fal-ai/ltx-2.3-quality/text-to-video/lora`
- **Category**: text-to-video
- **Kind**: inference
**Tags**: lora, text-to-video, video
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/text-to-video/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/text-to-video/lora", {
  input: {
    prompt: "A cowboy walking through a dusty town at high noon, camera following from behind, cinematic depth, realistic lighting, western mood, 4K film grain.",
    loras: [{
      path: "https://example.com/path/to/lora.safetensors",
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/text-to-video/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/text-to-video/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/text-to-video/lora)
