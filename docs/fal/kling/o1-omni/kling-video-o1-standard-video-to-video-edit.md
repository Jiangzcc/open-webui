...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/o1/standard/video-to-video/edit`
- **Model ID**: `fal-ai/kling-video/o1/standard/video-to-video/edit`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Replace the character in the video with @Element1, maintaining the same movements and camera angles. Transform the landscape into @Image1"
...
- **`video_url`** (`string`, _required_):
  ...
  - Examples: "https://v3b.fal.media/files/b/rabbit/ku8_Wdpf-oTbGRq4lB5DU_output.mp4"
...
- **`image_urls`** (`list<string>`, _optional_):
  ...
  - Array of string
  - Examples: ["https://v3b.fal.media/files/b/lion/MKvhFko5_wYnfORYacNII_AgPt8v25Wt4oyKhjnhVK5.png"]
...
- **`video`** (`File`, _required_):
  The generated video.
  - Examples: {"file_name":"output.mp4","file_size":7533071,"content_type":"video/mp4","url":"https://v3b.fal.media/files/b/0a86603b/YAlbB2535l07BTy1wpDeI_output.mp4"}
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/o1/standard/video-to-video/edit)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/o1/standard/video-to-video/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/o1/standard/video-to-video/edit)
