...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/decompression`
- **Model ID**: `fal-ai/ltx-2.3-quality/decompression`
- **Category**: video-to-video
- **Kind**: inference
**Tags**: decompression, denoise
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/decompression \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/decompression", {
  input: {
    video_url: "https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/decompression)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/decompression/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/decompression)
