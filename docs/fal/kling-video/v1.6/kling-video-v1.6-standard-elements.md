...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v1.6/standard/elements`
- **Model ID**: `fal-ai/kling-video/v1.6/standard/elements`
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v1.6/standard/elements)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v1.6/standard/elements/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1.6/standard/elements)
