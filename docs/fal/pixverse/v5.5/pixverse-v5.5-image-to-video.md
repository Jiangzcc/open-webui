...
- **Model ID**: `fal-ai/pixverse/v5.5/image-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/pixverse/v5.5/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/pixverse/v5.5/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/pixverse/v5.5/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v5.5/image-to-video)
